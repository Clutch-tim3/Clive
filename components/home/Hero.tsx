        ...
        <ScrollReveal>
          <div>
            ...
            <div className="hero-actions flex gap-3 flex-wrap mb-13">
              <Link 
                href="/#products" 
                className="btn-glow primary flex items-center gap-2 px-8 py-3.5 rounded-[100px] text-[11px] font-mono font-medium tracking-[0.1em] uppercase transition-all relative overflow-hidden"
              >
                Browse products
              </Link>
              <Link 
                href="/docs" 
                className="btn-glow ghost flex items-center gap-2 px-8 py-3.5 rounded-[100px] text-[11px] font-mono font-medium tracking-[0.1em] uppercase transition-all relative overflow-hidden"
              >
                Read the docs
              </Link>
            </div>
